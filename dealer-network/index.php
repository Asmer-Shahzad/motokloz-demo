        ...
        <div class="container">
                ...
                <form>
                    <div class="dealer-search-inner">
                        ...
                        <button class="btn-search" type="submit">
                            <img src="<?php echo $prefix; ?>/assets/images/Vector (4).png" alt="Search icon">
                            Find a Vehicle
                        </button>

                        <button class="btn-dealer" type="button">
                            Become a Dealer
                            <img src="<?php echo $prefix; ?>/assets/images/Vector (3).png" alt="Dealer icon">
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493.png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (1).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (2).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (3).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (4).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (5).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (6).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (7).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (8).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (9).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (10).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (11).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (12).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (13).png" class="dealer-avatar" alt="">
                            <div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="dealer-card">
                        <div class="d-flex align-items-start gap-3">
                            <img src="<?php echo $prefix; ?>/assets/images/Ellipse 6493 (14).png" class="dealer-avatar" alt="">
                            <div>
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-6">
                    ...
                    <button class="btn btn-dealer mt-2">
                        Get Started Now
                        <img src="<?php echo $prefix; ?>/assets/images/Vector (3).png" alt="">
                    </button>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6">
                            <img src="<?php echo $prefix; ?>/assets/images/Carento (1).png" class="mission-img" alt="">
                        </div>
                        <div class="col-6">
                            <img src="<?php echo $prefix; ?>/assets/images/Carento (2).png" class="mission-img" alt="">
                        </div>
                        <div class="col-5">
                            <img src="<?php echo $prefix; ?>/assets/images/Carento (3).png" class="mission-img" alt="">
                        </div>
                        <div class="col-7">
                            <img src="<?php echo $prefix; ?>/assets/images/Carento (4).png" class="mission-img" alt="">
                        </div>
                    </div>
                </div>
            </div>
