            ...
            <div class="col-lg-9">
                ...
                <div class="container">
                    <div class="card-container">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="preview-img-container">
                                    <img src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=300"
                                        class="preview-img" alt="Car">
                                    <div class="delete-btn"><i class="fa-solid fa-trash-can"></i></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="preview-img-container">
                                    <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=300"
                                        class="preview-img" alt="Car">
                                    <div class="delete-btn"><i class="fa-solid fa-trash-can"></i></div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="preview-img-container">
                                    <img src="https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&w=300"
                                        class="preview-img" alt="Car">
                                    <div class="delete-btn"><i class="fa-solid fa-trash-can"></i></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">A/C: Front</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Cruise Control</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Touchscreen display</label>
                                </div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Phone connectivity</label>
                                </div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">In-car Wi-Fi</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Brake assist (BA)</label></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Backup Camera</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Audio system</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">GPS navigation</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Breakfast</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Anti-lock brake system
                                        (ABS)</label></div>
                                <div class="form-check feature-checkbox"><input class="form-check-input"
                                        type="checkbox"> <label class="form-check-label">Airbags</label></div>
                            </div>
                        </div>
