...
<?php include 'include/header.php';?>
                                ...
                                <div class="swiper mySwiper">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card">
                                                <img src="/motokloz-demo/assets/images/Auto.png" class="img-fluid">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card">
                                                <img src="/motokloz-demo/assets/images/RV.png" class="img-fluid">
                                                <span>24 vehicles</span>
                                                <h4>RV</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card">
                                                <img src="/motokloz-demo/assets/images/Motorcycle.png"
                                                    class="img-fluid">
                                                <span>24 vehicles</span>
                                                <h4>Motorcycle</h4>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card">
                                                <img src="/motokloz-demo/assets/images/Powersports.png"
                                                    class="img-fluid">
                                                <span>24 vehicles</span>
                                                <h4>Powersports</h4>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card">
                                                <img src="/motokloz-demo/assets/images/Heavy Truck.png"
                                                    class="img-fluid">
                                                <span>24 vehicles</span>
                                                <h4>Heavy Truck</h4>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card">
                                                <img src="/motokloz-demo/assets/images/Trailers.png" class="img-fluid">
                                                <span>24 vehicles</span>
                                                <h4>Trailers</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card">
                                                <img src="/motokloz-demo/assets/images/Farm Equipment.png"
                                                    class="img-fluid">
                                                <span>24 vehicles</span>
                    ...
                    <div class="car-slider">
                        <div class="swiper carSwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="car-img">
                                        <img src="/motokloz-demo/assets/images/car1.png" class="img-fluid">
                                ...
                                <div class="swiper-slide">
                                    <div class="car-img">
                                        <img src="/motokloz-demo/assets/images/car2.png" class="img-fluid">
                                        <span class="rating">⭐ 4.96 (672 reviews)</span>
                                    </div>
                                    <div class="car-content">
                                        <h3>Audi Q5 2.0T Premium Plus</h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="car-img">
                                        <img src="/motokloz-demo/assets/images/car3.png" class="img-fluid">
                                        <span class="rating">⭐ 4.96 (672 reviews)</span>
                                    </div>
                                    <div class="car-content">
                                        <h3>Audi Q5 2.0T Premium Plus</h3>
    ...
    <section class="about-motokloz">
        ...
        <div class="car-wrap">
            <img src="/motokloz-demo/assets/images/suv.png" class="car img-fluid" alt="car">
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 testimonials-content">
                    <h4><img src="/motokloz-demo/assets/images/persons.png" class="img-fluid">Testimonials</h4>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="review-card">
                            <img src="/motokloz-demo/assets/images/star.png" class="img-fluid">
