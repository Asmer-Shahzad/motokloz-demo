                ...
                <div class="col-lg-8">
                    ...
                    <div class="mto-meta-row d-flex flex-wrap gap-3 mt-3">
                        ...
                        <span class="mto-meta-item flatt">
                            <img src="<?php echo $prefix; ?>/assets/images/code.png" alt="">
                    ...
                    <div class="mto-sticky-side">
                        ...
                        <div class="mto-card-unit p-4 shadow-sm">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <img src="<?php echo $prefix; ?>/assets/images/car-profile.png"
                            ...
                            <div class="mto-contact-details small fw-semibold">
                                ...
                                <div class="mb-2">
                                    <img src="<?php echo $prefix; ?>/assets/images/Background (8).png" alt="phone"
                                        class="contact-icon">
                                    Mobile: 1-222-333-4444
                                </div>

                                <div class="mb-2">
                                    <img src="<?php echo $prefix; ?>/assets/images/Background (10).png" alt="email"
                                        class="contact-icon">
                                    Email: emily-rose@gmail.com
                                </div>

                                <div class="mb-2">
                                    <img src="<?php echo $prefix; ?>/assets/images/Background (11).png" alt="whatsapp"
                                        class="contact-icon">
                                    WhatsApp: 1-222-333-4444
                                </div>

                                <div class="mb-2">
                                    <img src="<?php echo $prefix; ?>/assets/images/Background (12).png" alt="fax"
                                        class="contact-icon">
                                    Fax: 1-222-333-4444
                                </div>
