...
<body>
    ...
    <div class="map-banner">
        <img src="<?php echo $prefix; ?>/assets/images/map2.png" alt="Map" class="w-100 object-fit-cover"
            style="height: 350px;">
    </div>
        ...
        <div class="row">
                ...
                <div class="content-box shadow-sm">
                    ...
                    <div class="collapse show" id="overviewContent">
                        ...
                        <div class="d-flex align-items-center mb-4 border-bottom pb-4">
                            <img src="<?php echo $prefix; ?>/assets/images/Carento2.png" class="me-3 rounded"
                                alt="Logo">
                            <div>
                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                <img src="<?php echo $prefix; ?>/assets/images/Carento (10).png" class="gallery-img"
                                    alt="Car">
                            </div>
                            <div class="col-6">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <img src="<?php echo $prefix; ?>/assets/images/Carento (20).png"
                                            class="gallery-img" alt="Car">
                                    </div>
                                    <div class="col-12">
                                        <img src="<?php echo $prefix; ?>/assets/images/Carento (30).png"
                                            class="gallery-img" alt="Car">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="review mb-4">
                            <div class="d-flex justify-content-between align-items-center  review-header-custom">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo $prefix; ?>/assets/images/Travila01.png"
            ...
            <div class="col-lg-4">
                <div class="content-box shadow-sm">
                    ...
                    <button class="btn btn-orange w-100 mb-4">Send message <i
                ...
                <div class="content-box shadow-sm">
                    ...
                    <img src="<?php echo $prefix; ?>/assets/images/map.png" class="img-fluid rounded mb-3"
                        alt="Location Map">
