                ...
                <div class="modal-body p-3">
                    <div class="modal-gallery-grid">
                        @foreach ($images as $index => $img)
                            @php
                                $imgSrc = ($img == 'default' || str_contains($img,'car_thumb.png')) ? $defaultImage
                                            : (Str::startsWith($img,'http') ? $img : env('diskloz_base_url').'/admin_assets/images/inventory_images/'.$img);
                            @endphp
                ...
                <div class="col-lg-8">
                    ...
                    <div class="mto-specs-container mb-5" data-aos="fade-up" data-aos-delay="100" data-aos-duration="600">
                        <div class="row g-2">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="/assets/images/icon02.png" alt=""> {{ isset($searched_vehicle->condition) ? $searched_vehicle->condition : '' }}</div>
                            </div>
                            <div class="col-md-3 col-6">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="/assets/images/icon06.png" alt=""> {{ isset($searched_vehicle->type) ? $searched_vehicle->type : '' }}</div>
                            </div>
                            <div class="col-md-3 col-6">
                    ...
                    <div class="mto-details-stack">
                        ...
                        <div class="mto-stack-item mb-4" data-aos="fade-up" data-aos-duration="600" data-aos-delay="0">
                            ...
                            <div class="mto-stack-content show">
                                <p class="text-muted">{{ $searched_vehicle->description ? $searched_vehicle->description : 'No Description Mentioned!' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mto-stack-item mb-4">
                            ...
                            <div class="mto-stack-content">
                                ...
                                @php
                                    $featuresArray = json_decode($searched_vehicle->features ?? '[]', true);
                                @endphp
                ...
                <div class="col-lg-4" data-aos="fade-left" data-aos-duration="700" data-aos-delay="100">
                    <div class="mto-sticky-side">
                        ...
                        <div class="mto-card-unit p-4 shadow-sm">
                            ...
                            @else
                                <a class="link-text-decoration" href="{{ route('login') }}">
                                    <div class="d-flex align-items-center mb-4">
                                        <img src="{{ asset('assets/images/defaultavatar.png') }}"
                                            class="img-fluid dealerlogo rounded-circle me-3"
                                            alt="Login"
                                            onerror="this.onerror=null;this.src='{{ asset('assets/images/defaultdealerlogo.png') }}';">
