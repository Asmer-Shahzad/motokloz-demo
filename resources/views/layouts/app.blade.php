    ...
    <div class="mto-loader-box">
        ...
        <div class="mto-speedo-wrap">
            <svg class="mto-speedo" viewBox="0 0 160 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Outer ring -->
                <circle cx="80" cy="90" r="72" stroke="#111" stroke-width="1.5" stroke-dasharray="4 6" opacity="0.6"/>

                <!-- Track arc (background) -->
                <path d="M18 90 A65 65 0 0 1 142 90" stroke="#1c1c1c" stroke-width="10" stroke-linecap="round"/>

                <!-- Glow arc (blur layer) -->
                <path class="mto-speedo-glow" d="M18 90 A65 65 0 0 1 142 90"
                    stroke="#ff9d00" stroke-width="14" stroke-linecap="round" opacity="0.15"
                    stroke-dasharray="204" stroke-dashoffset="204"/>

                <!-- Main fill arc -->
                <path class="mto-speedo-fill" d="M18 90 A65 65 0 0 1 142 90"
                    stroke="url(#arcGrad)" stroke-width="10" stroke-linecap="round"
                    stroke-dasharray="204" stroke-dashoffset="204" filter="url(#glow-orange)"/>
                ...
                <!-- -60deg --> <line x1="80" y1="25" x2="80" y2="33" stroke="#444" stroke-width="2" transform="rotate(-60 80 90)"/>
                <!-- -45deg --> <line x1="80" y1="25" x2="80" y2="30" stroke="#333" stroke-width="1.5" transform="rotate(-45 80 90)"/>
                <!-- -30deg --> <line x1="80" y1="25" x2="80" y2="33" stroke="#444" stroke-width="2" transform="rotate(-30 80 90)"/>
                <!-- -15deg --> <line x1="80" y1="25" x2="80" y2="30" stroke="#333" stroke-width="1.5" transform="rotate(-15 80 90)"/>
                <!--   0deg --> <line x1="80" y1="25" x2="80" y2="33" stroke="#444" stroke-width="2" transform="rotate(0 80 90)"/>
                <!-- +15deg --> <line x1="80" y1="25" x2="80" y2="30" stroke="#333" stroke-width="1.5" transform="rotate(15 80 90)"/>
                <!-- +30deg --> <line x1="80" y1="25" x2="80" y2="33" stroke="#444" stroke-width="2" transform="rotate(30 80 90)"/>
                <!-- +45deg --> <line x1="80" y1="25" x2="80" y2="30" stroke="#333" stroke-width="1.5" transform="rotate(45 80 90)"/>
                <!-- +60deg --> <line x1="80" y1="25" x2="80" y2="33" stroke="#444" stroke-width="2" transform="rotate(60 80 90)"/>
                ...
                <g class="mto-needle-group" filter="url(#glow-needle)">
                    <!-- Needle tail -->
                    <line x1="80" y1="90" x2="80" y2="100" stroke="#ff6a00" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
                    <!-- Needle body -->
                    <line x1="80" y1="90" x2="80" y2="30" stroke="#ff9d00" stroke-width="2.5" stroke-linecap="round"/>
                    <!-- Needle tip glow dot -->
            ...
            <!-- Speed value display -->
            <div class="mto-speed-val"><span class="mto-speed-num">0</span><span class="mto-speed-unit">km/h</span></div>
        </div>

        <!-- Brand name with letter animation -->
        <div class="mto-loader-brand">
            <span style="--i:0">M</span><span class="mto-orange" style="--i:1">O</span><span style="--i:2">T</span><span style="--i:3">O</span><span style="--i:4">K</span><span style="--i:5">L</span><span style="--i:6">O</span><span style="--i:7">Z</span>
        </div>
...
<script>
    ...
    <style>
        ...
        #mto-lightbox.open { display: flex; }
        ...
        .mto-lb-counter {
            font-family: 'Urbanist', sans-serif;
            font-size: 13px; color: #aaa; letter-spacing: 1px;
        }
        .mto-lb-actions { display: flex; gap: 6px; }
        .mto-lb-btn {
        ...
        .mto-lb-btn svg { width: 16px; height: 16px; }
        .mto-lb-btn:hover { background: #ff9d00; color: #000; border-color: #ff9d00; }
        .mto-lb-close:hover { background: #e53e3e; border-color: #e53e3e; color: #fff; }
        ...
        .mto-lb-img-wrap.dragging { cursor: grabbing; }
        #mto-lb-img {
        ...
        .mto-lb-arrow {
            ...
            color: #ff9d00; font-size: 36px; line-height: 1;
            width: 52px; height: 52px; border-radius: 50%;
            cursor: pointer; z-index: 2;
            display: flex; align-items: center; justify-content: center;
            transition: background 0.2s, border-color 0.2s;
        }
        .mto-lb-arrow:hover { background: #ff9d00; color: #000; border-color: #ff9d00; }
        .mto-lb-prev { left: 16px; }
        .mto-lb-next { right: 16px; }
        ...
        #mto-lb-zoom-slider {
            width: 160px; accent-color: #ff9d00; cursor: pointer;
        }
