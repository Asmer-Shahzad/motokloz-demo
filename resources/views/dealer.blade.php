                    ...
                    <div style="    border-bottom: 1px solid #DDE1DE;     padding-bottom: 10px;"
                        ...
                        <div class="toolbar-left d-flex align-items-center">
                            <div class="view-icons me-3">
                                ...
                                <!-- Grid View -->
                                <svg id="gridViewBtn" width="22" height="24" viewBox="0 0 22 24" fill="none" class="light-dark me-2 gridbtn"
                                ...
                                <!-- List View -->
                                <svg id="listViewBtn" width="21" height="21" viewBox="0 0 21 21" fill="none" class="light-dark gridbtn"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
