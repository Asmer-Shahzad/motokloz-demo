                            ...
                            <div class="fp-searchable-select" id="fpSearchableSelect">
                                ...
                                <div class="fp-dropdown-box" id="fpDropdownBox" style="display:none;">
                                    ...
                                    <div class="fp-options-list" id="fpOptionsList">
                                        ...
                                        @foreach($dealerFloorPlanOptions as $fp)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fetchMakesBySingleType(type) {
            ...
            return fetch(`{{ env('diskloz_base_url') }}/api/dealer_by_id/${dealerId}?selected_asset=${encodeURIComponent(apiType)}&per_page=1`)
                .then(res => res.json())
                .then(data => {
            ...
            success: function(res) {
                if (res.success) {
                    if (isLiked) {
                        ...
                        $icon.removeClass('fas').addClass('far').css('color', '#aaa');
                    } else {
                        $btn.addClass('active');
