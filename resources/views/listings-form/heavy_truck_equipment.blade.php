...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <select class="form-select" id="axle_type" name="axle_type">
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Heated Wheels">
            <label class="form-check-label">Heated Wheels</label>
        </div>
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Radio">
    ...
    <div class="col-md-6">
        ...
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Heated">
            <label class="form-check-label">Heated</label>
        </div>
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="A/C">
            <label class="form-check-label">A/C</label>
        </div>
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Telescopic/Tilt">
            <label class="form-check-label">Telescopic/Tilt</label>
        </div>
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Other">
