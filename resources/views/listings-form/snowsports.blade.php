...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Electric Start">
            <label class="form-check-label">Electric Start</label>
        </div>
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="ECU(Electronic Control Unit)">
            <label class="form-check-label">ECU (Electronic Control Unit)</label>
        </div>
    </div>
    
    <div class="col-md-6">
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Turbo">
            <label class="form-check-label">Turbo</label>
        </div>
        <div class="form-check feature-checkbox">
            <input class="form-check-input" type="checkbox" name="features[]" value="Naturally Aspirated (N/A)">
            <label class="form-check-label">Naturally Aspirated (N/A)</label>
        </div>
    </div>
</div>
