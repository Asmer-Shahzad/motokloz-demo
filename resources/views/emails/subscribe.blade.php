                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="background-color:#222222; padding: 32px 40px; text-align:center;">
                            ...
                            <h1 style="margin:0; color:#ff9d00; font-size:22px; font-weight:700; letter-spacing:1px;">NEW SUBSCRIBER</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 36px 40px;">
                            ...
                            <p style="margin:0 0 24px; color:#555; font-size:15px; line-height:1.6;">
                                A new user has subscribed to receive deals and updates from <strong>Motokloz</strong>.
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding: 8px 0; border-bottom: 1px solid #eeeeee;">
                                                    <span style="color:#999; font-size:12px; text-transform:uppercase; letter-spacing:0.5px;">Email Address</span><br>
                                                    <strong style="color:#222; font-size:16px;">{{ $userEmail }}</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="color:#999; font-size:12px; text-transform:uppercase; letter-spacing:0.5px;">Subscribed At</span><br>
                                                    <strong style="color:#222; font-size:15px;">{{ $subscribedAt }}</strong>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
