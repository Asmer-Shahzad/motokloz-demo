...
<style>
    #oopss {
        background: linear-gradient(-45deg, #ff9d00, #101010);
        position: fixed;
        left: 0;
        top: 0;
        width: 100%;
    ...
    #oopss #error-text .back {
        ...
        padding: .7em 2em;
        border-radius: 500px;
        box-shadow: 0 20px 70px 4px rgba(0, 0, 0, 0.1), inset 7px 33px 0 0px #ff9d00;
        font-weight: 900;
    ...
    #oopss #error-text .back:hover {
        ...
        box-shadow: 0 35px 90px 4px rgba(0, 0, 0, 0.3), inset 0px 0 0 3px #101010;
    }
