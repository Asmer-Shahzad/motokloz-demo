                ...
                <div class="col-12">
                    ...
                    <div class="swiper thumb-strip-slider mt-3">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"><img src="<?php echo $prefix; ?>/assets/images/gallery10.png">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mto-specs-container mb-5">
                        <div class="row g-2">
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon01.png"
                                        alt=""> 56,500</div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon02.png"
                                        alt=""> Diesel</div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon03.png"
                                        alt=""> Automatic</div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon04.png"
                                        alt=""> 7 seats</div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon05.png"
                                        alt=""> 3 Large bags
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon06.png"
                                        alt=""> SUVs</div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon07.png"
                                        alt=""> 4 Doors</div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mto-info-tile"><img src="<?php echo $prefix; ?>/assets/images/icon08.png"
                                        alt=""> 2.5L</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mto-sticky-side">
                        ...
                        <div class="mto-card-unit p-4 shadow-sm">
                            ...
                            <div class="mto-contact-details small fw-semibold">
                                <div class="mb-2"><i class="fa-solid fa-phone me-2 text-muted"></i> Mobile:
                                    1-222-333-4444</div>
                                <div class="mb-2"><i class="fa-solid fa-envelope me-2 text-muted"></i> Email:
                                    emily-rose@gmail.com</div>
                                <div class="mb-2"><i class="fa-brands fa-whatsapp me-2 text-muted"></i> WhatsApp:
                                    1-222-333-4444</div>
                                <div class="mb-2"><i class="fa-solid fa-fax me-2 text-muted"></i> Fax: 1-222-333-4444
                                </div>
                            </div>
